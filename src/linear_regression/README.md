...
![mu-j](./formulas/mu-j.svg) - average value of _j<sup>th</sup>_ feature in training set

![s-j](./formulas/s-j.svg) - the range (_max - min_) of _j<sup>th</sup>_ feature in training set.
