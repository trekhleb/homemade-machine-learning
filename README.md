...
- ▶︎ [Univariate Linear Regression (Demo)](https://mybinder.org/v2/gh/trekhleb/homemade-machine-learning/master?filepath=src/linear_regression/univariate_linear_regression_demo.ipynb) - predict country happiness score by economy GDP per capita.
